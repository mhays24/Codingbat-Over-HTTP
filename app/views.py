...
def number_view(request: HttpRequest, n) -> HttpResponse:
    def near_hundred(n):
        return abs(100 - n) <= 10 or abs(200 - n) <= 10
    return HttpResponse(near_hundred(n))


def string_splosion_view(request: HttpRequest, word) -> HttpResponse:
    result = ""
...
def cat_dog_view(request: HttpRequest, animal) -> HttpResponse:
